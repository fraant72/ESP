...
#define I2C_MASTER_SCL                  22               /*!< gpio number for I4C master clock */
...
static uint8_t videomem[VideoMemSize];
...
void oledWriteVideoMem()
{
    ...
    i2c_end();
    i2c_init();
    i2c_master_write_byte(cmd,COMMAND_NEXT_BYTE_IS_DATA, ACK_CHECK_EN);
